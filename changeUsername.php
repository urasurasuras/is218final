<?php         
    ...
    if(isset($_POST) && isset($_SESSION))
    {
        ...
        if (empty($loginVerified)){// wrong password
            ...
            $result = $conn->changeUsername($loginInfo['username'], $_POST['new_username']);
            ...
            if (!empty($result)){ // Null result from runQuery, assume duplicate username
                ...
                $conn = new SqlConnection();
                $conn->connect();
                $loginInfo = $conn->doLogin($_POST["new_username"], $_POST["current_password"]);
                ...
                if (!empty($loginInfo)){
                    ...
                    $_SESSION['message'] = "Changed username to: ".$loginInfo['username'];
